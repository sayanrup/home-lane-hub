 ...
 * toward invented.
 *
 * All figures are exercise assumptions, not HomeLane operating data.
 */
...
export const KEY_FACTS = [
  { claim: "What HomeLane does", value: "Full home interiors: design, manufacture and installation." },
...
export const COMPOSITIONS: Record<Intent, Composition> = {
  cost: {
    ...
    headline: "A 3BHK with HomeLane usually lands between ₹6.5L and ₹11L.",
    answer:
  ...
  compare: {
    ...
    answer:
      "We will not tell you what anyone else does. Here is what HomeLane puts in writing: a fixed itemised price before work starts, 45-day installation from design sign-off, a 10-year warranty on modular cabinetry, and one team accountable from drawing to handover.",
  ...
  city: {
    ...
    answer:
      "HomeLane designs, manufactures and installs across 12 Indian cities with its own installation crews. Pick your city below for a plain yes or no.",
  ...
  generic: {
    ...
    answer:
      "HomeLane designs, manufactures and installs full home interiors. Fixed price agreed before work starts, handover in 45 days, 10-year warranty on modular cabinetry.",
    cta: "Book a free design session",
